        ...
        <div class="relative min-h-screen">
            ...
            <main class="relative isolate pt-14">
                 <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
                    <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80d4ff] to-[#3b82f6] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
                </div>

                <div class="py-24 sm:py-32">
                    <div class="mx-auto max-w-2xl text-center px-4">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Manajemen Pelaporan Proyek Menjadi Lebih Mudah</h1>
                        <p class="mt-6 text-lg leading-8 text-gray-600">Digitalisasi proses pelaporan proyek konstruksi Anda. Tingkatkan efisiensi, kurangi kesalahan, dan pantau progres secara real-time dari mana saja.</p>
                        <div class="mt-10 flex items-center justify-center gap-x-6">
                            <a href="{{ route('login') }}" class="rounded-md bg-sky-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Mulai Sekarang</a>
                        </div>
                    </div>
                </div>

                 <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
                    <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#3b82f6] to-[#93c5fd] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
                </div>
            </main>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-8 text-center">
                        <div class="p-6">
                            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-sky-600 text-white mx-auto mb-4">
                            ...
                            <p class="mt-2 text-gray-600">Pelaksana lapangan dapat menginput laporan harian langsung dari lokasi proyek.</p>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-sky-600 text-white mx-auto mb-4">
                            ...
                            <p class="mt-2 text-gray-600">Admin dapat memverifikasi atau menolak laporan dengan mudah, lengkap dengan catatan revisi.</p>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center justify-center h-12 w-12 rounded-md bg-sky-600 text-white mx-auto mb-4">
                            ...
                            <p class="mt-2 text-gray-600">Unduh data laporan dalam format PDF untuk arsip atau Excel untuk analisis data lebih lanjut.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer class="bg-gray-800 text-gray-400">
                <div class="container mx-auto px-6 py-8">
                    <div class="flex justify-between items-center">
                        <div>
                            <p class="text-sm">&copy; {{ date('Y') }} Sistem Pelaporan Proyek. All rights reserved.</p>
                            <p class="text-xs mt-1">Dikembangkan oleh Alam Ruslam untuk Skripsi.</p>
                        </div>
                        <div class="text-sm">
                            <a href="#top" class="hover:text-white">Kembali ke Atas</a>
                        </div>
                    </div>
                </div>
            </footer>
